...
Zone = '<System>{request_text}</System>'
...
class RXV(object):
    ...
    def __init__(self, ctrl_url, model_name="Unknown",
                 zone="System", friendly_name='Unknown',
                 unit_desc_url=None):
    ...
    def small_image_url(self):
        ...
        return "http://{}:80/BCO_device_sm_icon.png".format(host)

    @property
    def large_image_url(self):
        host = urlparse(self.ctrl_url).hostname
        return "http://{}:80/BCO_device_lrg_icon.png".format(host)